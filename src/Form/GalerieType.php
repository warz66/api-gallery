...
{   
    ...
    {   
        ...
        $builder
            ...
            ->add('par_ordre', ChoiceType::class, ['label' => 'Trier par ordre', 'label_attr' => ['class' => 'font-weight-bold'], 'choices' => ['Ordre des tableaux croissant' => 'OrdreTableauAsc', 'Ordre des tableaux décroissant' => 'OrdreTableauDesc'], 'placeholder' => false])
