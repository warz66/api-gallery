...
{   
    ...
    {   
        ...
        $builder
            ...
            ->add('reference', TextType::class, ['label' => 'Nom de la référence', 'required' => false, 'attr' => ['placeholder' => 'Veuillez choisir un nom de référence pour cette galerie', 'maxlength' => '100'],'label_attr' => ['class' => 'font-weight-bold']])
